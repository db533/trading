...
urlpatterns = [
    ...
    path('swing_point_graph/<int:opp_id>/<int:magniture>/', generate_swing_point_graph_view, name='swing_point_graph'),
    ...
    path('trading-performance-list/<str:status>/', trade_performance_list, name='trade_performance_list'),
