...
class BearishKicker(CandlestickFinder):
    ...
    def logic(self, idx):
        ...
        return (
               prev_close > prev_open  # Prior candle is upward
               and (open <= prev_open)  # Next candle opens below the prior candle's open.
               and (close < open ) # Next candle closes down
        )
