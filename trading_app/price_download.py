...
def get_price_data(ticker, interval, start_time, finish_time, logger):
    ...
    try:
        ...
        if existing_data_retrieved == True:
            ...
            step = 8
            existing_df['Datetime_TZ'] = existing_df['Datetime_TZ'].tz_convert('UTC').tz_localize(None)
            existing_df['Datetime'] = existing_df['Datetime'].tz_convert('UTC').tz_localize(None)
            logger.info(f'step = {step}')
