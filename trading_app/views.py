...
STRATEGY_METRICS_LABELS = {
    ...
    "Gann's Buying point #3": {
        ...
        'prior_trend_duration': 'Duration of downtrend',
        'secondary_upswing_size': 'Secondary upswing price change as % of secondary price',
    ...
    "Gann's Selling point #3": {
        ...
        'prior_trend_duration': 'Duration of uptrend',
        'secondary_downswing_size': 'Secondary downswing price change as % of secondary price',
        'initial_upswing_size': 'Initial upswing price change as % of LL price',
